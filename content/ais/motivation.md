---
title: Personal Motivations for Mitigating AI Risk
draft: false
lang: en
date: 2025-03-26
tags:
...
_Note: Quality of this post is mid, will improve soon._
...
I am worried that we are close to unleashing powers that our [medieval institutions cannot handle and our paleolithic minds cannot comprehend](https://www.goodreads.com/quotes/9770741-the-real-problem-of-humanity-is-the-following-we-have). We may soon face AI with the combined intelligences of history's greatest minds, replicated across billions of devices, working without rest at speeds magnitudes faster than humans, and communicating at light-speed with instant access to the entirety of human knowledge. As many have noted, [superintelligence will likely be humanity's last invention](https://www.azquotes.com/quote/1215137).
...
The dangers aren't theoretical — present day models are already capable of [deception](https://arxiv.org/pdf/2401.05566.pdf), reward hacking, [hiring and manipulating humans to complete tasks](https://metr.org/blog/2023-03-18-update-on-recent-evals/), writing sophisticated code, autonomously browsing the web, [manipulating humans to preserve its values](https://www.anthropic.com/research/alignment-faking) [^1] and emotionally manipulating humans. All it takes is one person giving a large language model access to a computer and internet for there to be a significant hazard.
...
There's no reason to believe humans represent the upper limit of possible intelligence. [AI not trained on human data has no difficulties achieving human-level performance](https://freedom-to-tinker.com/wp-content/uploads/2018/01/Screen-Shot-2018-01-03-at-12.01.00-PM-1024x625.png), and the intelligence gap between future AI and humans could be akin to the difference between humans and insects — particularly if we consider the possibility of [recursive self-improvement](https://www.historyofinformation.com/detail.php?id=2142).
...
<!-- If I didn't think superintelligence was coming anytime soon, I might work on theoretical physics. But right now, I believe that theoretical physics research won't really make the world much better since superintelligence is likely to do it not too far down the line. -->
