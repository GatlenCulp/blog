---
title: My Journey into AI Security
description: A timeline of my work in the field of AI Security
draft: false
lang: en
date: 2025-03-26
tags:
...
```mermaid
timeline
    title My AI Security Journey Timeline
    ...
    section Organization & Growth (2022-2024)
        ...
        2023-2024 : Technical training and network building
                  : Tools development for AI Security orgs
    ...
    section Future Path
        Fall 2025 : Early MIT graduation
                  : Full-time AI Security career focus
```
...
My AI Security journey began at MIT in 2021 when I discovered Effective Altruism[^1] as a freshman seeking career direction. I quickly immersed myself in popular EA/AIS literature[^2] and community engagement through the EA-Intro Fellowship, two EAGs, and an AI Security workshop. During this period, I wrote [an article on Transformative AI](./transformative-ai.md) to solidify some of my fundamental thoughts on AI for a general audience.
...
During 2023, I completed [AI Security Fundamentals (technical track)](https://aialignment.mit.edu/getinvolved/)[^5] I also attended specialized workshops (two [AISST-MAIA technical workshops, one policy-focused](https://aialignment.mit.edu/getinvolved/), and another hosted in Constellation for university group organizers) and conferences (EAGxLATAM and others).
