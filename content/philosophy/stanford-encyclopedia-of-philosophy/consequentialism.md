...
Consequentialism can technically encapsulate weird theories such as “increasing the number of goats in Texas”.
...
> **Counter Arguments Against Hedonism (Experience Machine)**
...
> Preference Utilitarianism and the Experience Machine
...
- **Ideal Utilitarianism = Utilitarianism with Pluralistic Theory of Value.**
Ideal utilitarianism takes into account values of beauty and truth/knowledge in addition to pleasure. (Possibly other values as well)
    
    
    (also combination of pleasure and capabilities)
    
    Welfarist — Values concern individual welfare
    
    Perfectionism (non-welfarist) — Certain states make a person’s life good without increasing the person’s welfare. (sometimes not considered utilitarian)
    
    Or Maximization of utilitarianism of fufilling certain moral rights.
...
- **Holistic Consequentialism/World Utilitarianism**
    ...
    This basically feels like sophisticated utilitarianism over naive utilitarianism. Just “does this result in a better world” by utilitarian standards. I might not interpret this right.
    
    > opponents often charge that classical utilitarians cannot explain our obligations to keep promises and not to lie when no pain is caused or pleasure is lost
...
> **Uncertainty + Utilitarianism ≠ Moral skepticism**
...
*Actual vs Expected vs Foreseen vs Forseeable Consequentialism/Utilitarianism. Separating blaming a person from the morality of an action.*
****
> 
> 
...
From this quote, I don’t know what I’d say. I think actual consequentialism might be bull. I think that acquiring knowledge to make good decisions is a part of the moral imperative. Deciding to acquire knowledge is itself is an action though. I don’t know how to balance this. I think the measure of an action should be **Subjective Expected Utility.** I feel like this topic comes down to “should we blame a person?” and the terms we use inform this. The consequence of calling it a “blameless bad action” hurts the person who committed the action. While just saying “it was an expected good action” doesn’t hurt the person. The decision procedure does not change in either situation. I’m using utilitarianism to justify the words we use lol.

> **Proximate Consequentialism**
...
> **Utilitarianism Overlooking Justice and Rights**
...
Might lead to very bad societal effects, thus bad. But no, don’t care about the line of taking a life. Many will modify utilitarianism to fix these issues, for example saying a killing is worse than a death. But when we say a murderer stabbed these 5 people, then it falls apart.

> **Agent-relative vs agent-neutral Consequentialism (Again, I think this is a blame game because it doesn’t change the decision procedure)**
...
It feels like this is just saying “an action is good/bad iff the agent considers the action good/bad”. Imo you should blame the person for the action if it is worth it, otherwise don’t.  I’m agent-neutral I guess if I understand this properly. Agent relative just sounds like lazy consequentialism. AHHH I probably don’t understand, take another look at this.

More interesting thought experiment, don’t know how it relates to agent-relative/neutral tho
...
To fix utilitarian demandingness, you can redefine an act to be morally wrong only when it fails to maximize utility AND its agent should be punished for the failure (which is not always utility maximizing). (Mill) (I don’t know, it’s possible.). But generally says “not necessarily morally wrong to fail to maximize utility, doing this is an ‘ought’ not a ‘must’” Alternatively, you can apply proximate cause and say you don’t have to donate because you were not responsible. (Offering aid to a drowning person is not always legally required)

- Satisficing consequentialism — Instead of maximizing utility, we try to create a bar for the amount of utility we ought to create. **Possibly based?**
- Progressive consequentialism — Morally ought to improve the world or make it better than it would if we did nothing (ie: leave it better than you found it) **Possibly valid?**
- Scalar consequentialism — Defines how good an act is on a scale of wrongness to rightness. (ex: Donating $10000 more right than $1000 more right than $100. **Based, but I feel like utilitarians do this anyways.**
- Contrastivist consequentialism — Don’t fully understand but I don’t think it is terribly important

“It remains controversial, however, whether any form of consequentialism can adequately incorporate common moral intuitions about friendship.”

> **Consequentialism may be the inference to best explain our moral intuitions**
...
> **Utilitarianism might be supported from deductive arguments**
> 
> 
